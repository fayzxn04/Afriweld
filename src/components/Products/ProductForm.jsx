...
//       //     const uploadedUrl = await addFile(
//       //       formData.imageUrls[i],
//       //       "image",
//       //       `products/${id}/${v4()}`
//       //     );
...
//       //   for (let i = 0; i < formData.imageUrls.length; i++) {
//       //     if (typeof formData.imageUrls[i] === "string") {
//       //       uploadedImages.push(formData.imageUrls[i]); // keep old URL
//       //     } else {
//       //       const uploadedUrl = await addFile(
//       //         formData.imageUrls[i],
//       //         "image",
...
//             }}
//             // setFile={(files) => {
//             //   // prepend latest uploaded image
//             //   setFormData((prev) => ({
//             //     ...prev,
//             //     imageUrls: [files, ...prev.imageUrls],
//             //   }));
//             // }}
//             setModalImage={() => {}}
//             setOpenModal={() => {}}
